		...
		return {
			...
			menus : {
				EVENT_TYPE : {
					...
					items : [
						/* BEGIN HANDLERS */
						"activate", "listBoxActivate", "treeViewActivate", "resize", "tick", "menu", "mouseDown", "mouseUp", "mouseMove", "changed", "comboBoxChanged", "key", "keyRelease", "close", "focusIn", "focusOut", "fileChosen", "directoryChosen", "colorChosen", "draw", "clipboard", "darkTheme"
						/* END HANDLERS */
					]
				},
				INTEGER_PROP : {
			...
			blocks : [
				...
				},
				{
					opcode : "create",
					blockType : Scratch.BlockType.REPORTER,
					text : "New [WIDGET_CLASS] widget named [NAME] at ([X], [Y]) with size [WIDTH]x[HEIGHT] as the child of [PARENT]",
					arguments : {
						WIDGET_CLASS : {
							type : Scratch.ArgumentType.STRING,
							menu : "WIDGET_CLASS",
				...
				},
				{
					opcode : "register",
					blockType : Scratch.BlockType.COMMAND,
					text : "Register custom block [CUSTOM] as event [EVENT] for widget [WIDGET]",
					arguments : {
						CUSTOM : {
							type : Scratch.ArgumentType.STRING
						},
